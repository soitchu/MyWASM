...
test("test_push_pop", () => {
    ...
    console.assert(len(table) == 1)
    table.pop_environment()
    console.assert(len(table) == 0)
    table.push_environment()
    table.push_environment()    
    console.assert(len(table) == 2)
    table.pop_environment()
    console.assert(len(table) == 1)
    table.pop_environment()
    console.assert(len(table) == 0)
...
test("test_simple_add", () => {
    ...
    // @ts-expect-error
    table.add("x", "int")
    console.assert(!table.exists("x"))
    table.push_environment()
    // @ts-expect-error
    table.add("x", "int")
    // @ts-expect-error
    console.assert(table.exists("x") && table.get("x") === "int")
    table.pop_environment()
});
...
test("test_multiple_add", () => {
    ...
    table.add("y", "double")
    console.assert(table.exists("x") && table.get("x") == "int")
    console.assert(table.exists("y") && table.get("y") == "double")
});
...
test("test_multiple_environments", () => {
    ...
    table.push_environment()
    table.add('u', 'Node')
    console.assert(table.exists('x') && table.get('x') == 'string')
    console.assert(table.exists('y') && table.get('y') == 'double')
    console.assert(table.exists('z') && table.get('z') == 'bool')
    console.assert(table.exists('u') && table.get('u') == 'Node')
    console.assert(!table.exists_in_curr_env('x'))
    console.assert(!table.exists_in_curr_env('y'))
    console.assert(!table.exists_in_curr_env('z'))
    console.assert(table.exists_in_curr_env('u'))
    table.pop_environment()
    console.assert(!table.exists('u'))
    console.assert(table.exists_in_curr_env('x') && table.get('x') == 'string')
    console.assert(table.exists_in_curr_env('z') && table.get('z') == 'bool')
    table.pop_environment()
    console.assert(!table.exists('z'))
    console.assert(table.exists('x') && table.get('x') == 'int')
    console.assert(table.exists('y') && table.get('y') == 'double')
    table.pop_environment()
});
...
test("test_smallest_program", () => {
    ...
    new ASTParser(new Lexer(new StringBuffer(in_stream))).parse().accept(new SemanticChecker())
});
...
test("test_two_functions_same_name", () => {
    ...
    try {
        new ASTParser(new Lexer(new StringBuffer(in_stream)), undefined, false).parse().accept(new SemanticChecker())
    } catch(e: any) {
        console.assert((e.message as string).startsWith("(2)"));
    }
});
...
test("test_function_with_two_params_same_name", () => {
    ...
    try {
      ...
      console.assert((e.message as string).startsWith("(27)"));
    }
});
...
test("test_function_with_bad_param_type", () => {
    ...
    try {
        ...
        console.assert((e.message as string).startsWith("(26)"));
    }
});
...
test("test_two_structs_same_name", () => {
    ...
    try {
      ...
      console.assert((e.message as string).startsWith("(1)"));
    }
});
...
test("test_struct_with_undefined_field_type", () => {
    ...
    try {
      ...
      console.assert((e.message as string).startsWith("(9)"));
    }
});
...
test("test_struct_with_same_field_names", () => {
    ...
    try {
      ...
      console.assert((e.message as string).startsWith("(8)"));
    }
});
...
test("test_mismatched_var_decl_types", () => { 
    ...
    try {
      ...
      console.assert((e.message as string).startsWith("(12)"));
    }
});
...
test("test_bad_relational_comparison", () => {
    ...
    try {
      ...
      console.assert((e.message as string).startsWith("(24)"));
    }
});
...
test("test_bad_array_relational_comparison", () => {
    ...
    try {
      ...
      console.assert((e.message as string).startsWith("(54)"));
    }
});
...
test("test_bad_logical_negation", () => {
    ...
    try {
      ...
      console.assert((e.message as string).startsWith("(25)"));
    }
});
...
test("test_bad_function_return_type", () => {
    ...
    try {
      ...
      console.assert((e.message as string).startsWith("(11)"));
    }
});
...
test("test_bad_non_bool_if", () => {
    ...
    try {
      ...
      console.assert((e.message as string).startsWith("(16)"));
    }
});
...
test("test_bad_bool_while", () => {
    ...
    try {
      ...
      console.assert((e.message as string).startsWith("(14)"));
    }
});
...
test("test_bad_bool_condition_for1", () => {
    ...
    try {
      ...
      console.assert((e.message as string).startsWith("(15)"));
    }
});
...
test("test_call_to_undeclared_function", () => {
    ...
    console.assert((e.message as string).startsWith("(17)"));
}
});
...
test("test_too_few_args_in_function_call", () => {
    ...
    console.assert((e.message as string).startsWith("(18)"));
}
});
...
test("test_print_struct_object", () => {
    ...
    console.assert((e.message as string).startsWith("(19)"));
}
...
test("test_itos_bad_arg", () => {
    ...
    console.assert((e.message as string).startsWith("(20)"));
}
...
//     ast = new ASTParser(new Lexer(new StringBuffer(in_stream))).parse()
...
//     with pytest.raises(MyPLError) as err:
//         ast.accept(visitor)
    
//     console.assert(str(err.value) == Static Error: (12) Type mismatch. Tried assigning "bool" to "int" at line 14, column 21)
...
//     console.assert(str(err.value) == Static Error: (37) Cannot read "d" from "int" at line 9, column 44)
...
//     console.assert(str(err.value) == Static Error: (37) Cannot read "t" from "array Node" at line 8, column 27)
...
//     console.assert(str(err.value) == Static Error: (23) Operations can only be performed on same types, but got "double" && "int" at line 22, column 40)
...
//     console.assert(str(err.value) == Static Error: (54) Can\t use operator "+" on arrays at line 5, column 36)
